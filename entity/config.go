...
type Config struct {
	...
	OssUploadFunc func(config OssConfig, backupConfig BackupConfig) bool `yaml:"-"` //对象存储上传回调函数
	OssRemoveFunc func(config OssConfig, backupConfig BackupConfig) bool `yaml:"-"` //对象存储移除数据函数
}
